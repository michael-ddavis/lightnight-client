    ...
    <main>
      ...
      <div className="xl:mx-auto xl:max-w-full relative">
        <img
          src={aboutBanner}
          alt=""
          className="aspect-[5/2] w-full object-cover lg:h-96 brightness-50"
        />
        <h1 class="absolute text-2xl md:text-4xl lg:text-6xl text-white font-bold uppercase tracking-wide top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          About Us
        </h1>
      </div>
      ...
      <div className="relative isolate overflow-hidden bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <p className="text-xl font-semibold leading-8 tracking-tight text-indigo-600">
              Light Night History
            </p>
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
            <div className="relative lg:order-last lg:col-span-5">
              <figure className="border-l border-indigo-600 pl-8">
                <blockquote className="text-2xl font-semibold leading-8 tracking-tight text-gray-900">
                  <p>
                ...
                <figcaption className="mt-4 flex gap-x-4">
                  <div className="text-sm leading-6">
                    <div className="font-semibold text-gray-900">John 1:5</div>
                  </div>
                </figcaption>
              </figure>
            </div>
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:col-span-7">
              <p>
                In 2020, we got a Word from God saying "have a worship night".
                Who knew that such a seemigly simple Word could have turned into
                this. As we have grown and continue to grow, God is adding to
                what Light Night is doing andd its reach. Only He could have
                done this and we give Him all the praise, glory and honor for
                it.
              </p>
            </div>
          </div>
      ...
      <div className="p-4 sm:px-6 lg:px-16">
        {/* Logo cloud */}
        <div className="mx-auto mt-8 max-w-7xl sm:mt-40">
